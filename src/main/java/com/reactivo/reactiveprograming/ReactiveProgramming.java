...
public class ReactiveProgramming {
    ...
    public Flux<BigDecimal> mapFluxFromStringToBigDecimal(Flux<String> flux){ //Asincrono
        return flux.map(BigDecimal::new);
    }

    public Mono<BigDecimal> mapMonoFromStringBigDecimalMas099(Mono<String> mono){
